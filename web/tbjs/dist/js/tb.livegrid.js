    ...
    Livegrid.prototype = {
      ...
      _gApplyResizeItems: function() {
        ...
        //this.objList.forEach(function(obj) {
          ...
          this._gSetItemAtIndex(obj.xCalcTemp, obj.yCalcTemp, obj, this.g.indexTableTemp);
        });
      ...
      updateItems: function( data ) {
        ...
        for ( var i = 0, l = data.length; i < l; i++ ) {
          ...
          for ( var contentName in rawObj.contents ) {
            ASSERT( _.isString(rawObj.contents[ contentName ]) || _.isNumber(rawObj.contents[ contentName ]), contentName, i, rawObj.contents[ contentName ] );
            ASSERT( _.includes( this.types[obj.type].contentsNameList, contentName ), { msg: 'Expected known "content" for type "' + obj.type + '" for each object while updating data', }, this.types[obj.type].contentsNameList, contentName );
