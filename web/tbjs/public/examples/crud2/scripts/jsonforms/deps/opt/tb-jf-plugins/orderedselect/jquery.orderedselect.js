;(function($) {
  ...
  $.fn.orderedSelect = function(customOptions) {
    ...
    return this.each(function() {
       ...
       * if unintended items being added.
       */
      ...
      function buildSelect() {
        ...
        console.log($originalSelect.children('option').length);
        ...
        // IE6, IE7, IE8 requires this on every init or nothing appears
      ...
      function triggerOriginalChange(optionId, type) {
        ...
        $originalSelect.trigger('change', [{
          ...
          value: $option.val(),
          id: optionId,
          item: $fakeSelect.children('[rel=' + optionId + ']'),
          type: type,
        }]);
